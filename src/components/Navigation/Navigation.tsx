      ...
      <Navbar
        ...
        className={` ${
          state.showMobileMenu || state.isScrolled
            ? "bg-white"
            : "bg-transparent"
        }  backdrop-blur-0 block h-16 lg:h-auto sticky top-0 z-10   transition-background-color duration-700   w-screen items-center lg:flex rounded-none shadow-none  drop-shadow-none max-w-none  py-4 p-0`}>
        <Link
          href="/"
          className={`${
